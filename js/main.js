(function () {
  ...
  function renderFeaturedProducts() {
    ...
    const featured = window.ARVEL_PRODUCTS
      .filter((product) => (product.featured === true || product.featured === "true" || product.featured === 1) && (!product.status || product.status === "published") && !product.soldOut && !product.archived)
